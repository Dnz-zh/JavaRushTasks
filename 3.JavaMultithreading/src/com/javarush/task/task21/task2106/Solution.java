...
*/
    ...
    public static void main(String[] args) {
        /*
        Solution solution = new Solution(1, null, 1.0f, new Date(), null);
        Solution solution1 = new Solution(1, "1", 1.0f, new Date(), solution);
        Solution solution2 = new Solution(1, "1", 1.0f, new Date(), solution);
        System.out.println(solution.equals(solution2));
        */
    }
}
